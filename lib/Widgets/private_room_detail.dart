...
class _PrivateRoomDetailState extends State<PrivateRoomDetail> {
  ...
  List<Widget> restWidgets(context, room) {
          ...
          children: [
            Text(
              "${AppLocalizations.of(context).translate(
                  'Exercise Time (Seconds):')} ${room.exerciseTime}",
              style: Theme
                  .of(context)
                  .textTheme
                  .subtitle1,
            ...
            Text(
              "${AppLocalizations.of(context).translate(
                  'Rest Time (Seconds):')} ${room.restTime}",
              style: Theme
                  .of(context)
                  .textTheme
                  .subtitle1,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<TriviaRoom>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            actions: MediaQuery.of(context).size.height >
                    MediaQuery.of(context).size.width
                ? null
                : FirebaseAuth.instance.currentUser!.uid == room.managerID
                    ? <Widget>[
                        Padding(
                  ...
                  Container(
                    ...
                    child: FutureBuilder(
                      future: Provider.of<TriviaRoomProvider>(context,
                              listen: false)
                          .get_scoreboard(room.id, room.questions.length),
